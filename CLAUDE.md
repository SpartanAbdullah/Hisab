...
- **i18n:** every user-facing string lives in `src/lib/i18n.ts` as `{ ur, en }` — `ur` is roman Urdu (Latin script) and is the default language. No hardcoded English in JSX; check both languages render.
