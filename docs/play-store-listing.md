# Hisaab — Play Store Listing Copy

Ready to paste into Play Console → **Grow → Store presence → Main store listing**.
Synthesized from three competing drafts (khata-cultural / feature-clarity / trust-peace).
...
## App title (≤ 30 chars · this is 29)
```
Hisaab: Khata/Expense Tracker
```

> **Correction, 2026-09-02:** the previous title, `Hisaab: Khata & Expense
> Tracker`, is 31 characters — one over Play's 30-char limit — and had never
> actually been counted (the header carried no count). Re-verified here by
> direct string length, not by eye.

## Short description — English (≤ 80 chars · this is 73)
```
...
🪙 Kameti / committee (BC) — see whose baari it is, who has paid, and a provably-fair parchi draw. Share an expiring, revocable witness link so every member can verify the round themselves
📝 Edit history — see who changed what on a loan record, so a disagreement settles itself instead of turning into a fight
🛡️ Block or report — you stay in control of who you're connected to, right from the app
...
Running a committee/BC with friends or family? Hisaab gives every member a tamper-proof record of contributions and a provably-fair draw order the organiser cannot re-roll. It is a savings committee TRACKER — Hisaab never collects, holds or pays out money. That stays between you and your group. Sood-free by design.

== HONEST BY DESIGN ==

Hisaab is NOT a lender. It is an expense, khata and budget tracker — not a bank, lender or payment service. We never hold, move, lend or transfer a single rupee or dirham. We only help you keep track of money you already have, have lent, or are owed — a clean digital khata-kitab for your whole money life.

Perfect for students, families, freelancers, overseas workers, flatmates and anyone running a kameti or keeping a khata.

Stop guessing. Start seeing. Download Hisaab — your money, always in sight.

Search: hisaab, hisab kitab, khata, udhaar, expense tracker, budget app, kameti, committee, BC, qist, split bill, loan tracker, money manager, AED PKR, Pakistan UAE.
```
...
🪙 Kameti / committee (BC) — kis ki baari hai, kis ne paisa diya, aur provably-fair parchi draw. Ek expiring, revoke-able witness link share karein taake har member khud verify kar sake
📝 Edit history — kisi qarz (loan) record mein kis ne kya badla, yeh dekhein — behes khud khatam ho jati hai
🛡️ Block ya report karein — aap hamesha control mein hain ke kis se connected rehna hai, app ke andar hi
...
Doston ya ghar walon ke saath BC chala rahe hain? Hisaab har member ko contributions ka tamper-proof record aur provably-fair draw order deta hai jise organiser dobara roll nahi kar sakta. Yeh ek savings committee TRACKER hai — Hisaab kabhi paisa nahi leta, na rakhta, na deta. Woh aap aur aap ke group ke darmiyan rehta hai. Sood se paak.

== imaandari se banaya gaya ==

Hisaab koi lender nahi hai. Yeh ek kharcha, khata aur budget tracker hai — na bank, na qarz dene wala, na payment service. Hum kabhi ek rupiya ya dirham na rakhte hain, na bhejte, na qarz dete. Hum sirf woh paisa track karne mein madad karte hain jo aap ke paas pehle se hai, aap ne diya, ya lena hai — aap ki poori money life ka saaf digital khata-kitab.

Students, gharanon, freelancers, bahar kaam karne walon, flatmates aur kameti ya khata rakhne walon ke liye behtareen.

Andaze lagana band karein. Dekhna shuru karein. Hisaab download karein — aap ka paisa, hamesha nazar mein.
```
...
## Policy / reviewer notes (for your reference when filling declarations)
- **No lending language anywhere.** Loans are framed only as a tracking ledger ("money you've lent or are owed", "khata/udhaar"). No "get a loan", "borrow", "instant loan", "credit", "APR", "cash advance". → supports the **Financial features = "no financial features"** declaration.
