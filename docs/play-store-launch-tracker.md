...
| C4 | Design the consistent Hisaab logo (pick a concept) | 🔄 | Awaiting your pick of A/B/C |
| C5 | Produce ALL icon assets from the chosen logo | ⏳ | favicon.svg, PWA 192/512 + maskable, apple-touch-icon, Android adaptive mipmaps, in-app mark |
...
| C10 | Sentry wiring matches final decision | 🚧 | Waiting on Y2 (your Sentry decision) |
...
| Y2 | Decide: Sentry crash reporting yes/no for v1 | ⏳ | See recommendation in chat; affects Data Safety form |
