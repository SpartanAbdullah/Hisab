...
const S = {
  ...
  kameti_verify_title: { ur: "Parchi — verify ho sakti hai", en: "Provably-fair draw" },
  kameti_verify_desc: { ur: "Organizer par bharosa zaroori nahi — koi bhi is parchi ko khud check kar sakta hai.", en: "You don't have to trust the organizer — anyone can check this draw." },
  kameti_commitment: { ur: "Parchi ka fingerprint", en: "Draw fingerprint" },
  kameti_verify: { ur: "Parchi verify karein", en: "Verify this draw" },
  kameti_verifying: { ur: "Check ho raha…", en: "Checking…" },
  kameti_verify_ok: { ur: "Verified ✓ — tarteeb seal-shuda seed se milti hai", en: "Verified ✓ — the order matches the sealed seed" },
  kameti_verify_fail: { ur: "Match nahi — kuch badla hai", en: "Doesn't match — something changed" },
