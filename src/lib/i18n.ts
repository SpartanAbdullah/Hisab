...
const S = {
  ...
  mode_splits_title: { ur: 'Simple Splits aur Expense Notes', en: 'Simple Splits & Personal Expense Notes' },
  mode_splits_sub: { ur: 'Groups, kharche, qarz aur approvals', en: 'Groups, expense notes, loans, and approvals' },
  ...
  mode_splits_3: { ur: 'Payables aur receivables bhi dekhein', en: 'View payables and receivables too' },
  ...
  onboard_tagline: { ur: 'Qarz, kharche aur splits ka saaf hisaab.', en: 'Clear tracking for loans, expenses, and splits.' },
  onboard_bullet_1: { ur: 'Loans, payables aur receivables track karein', en: 'Track loans, payables, and receivables' },
  onboard_bullet_2: { ur: 'Dekhein kisne dena hai aur aapne kisko dena hai', en: 'Know who owes you and whom you owe' },
  onboard_bullet_3: { ur: 'Polite reminder messages copy/share karein', en: 'Copy or share polite reminder messages' },
  onboard_bullet_4: { ur: 'Accounts, expenses aur group splits manage karein', en: 'Manage accounts, expenses, and group splits' },
  onboard_start: { ur: 'Shuru Karein', en: 'Get Started' },
  onboard_footer: { ur: 'Aapke records ke liye secure sync. Control aapke paas rehta hai.', en: 'Secure sync for your records. You stay in control of your data.' },
  ...
  onboard_safety_title: { ur: 'Aapka Data, Aapka Control', en: 'Your Data, Your Control' },
  onboard_safety_sub: { ur: 'Aapke records securely store aur sync hote hain.', en: 'Your records are securely stored and synced for your account.' },
  onboard_safety_1: { ur: 'Financial records aapke account ke private rehte hain', en: 'Your financial records stay private to your account' },
  onboard_safety_1_sub: { ur: 'Sirf aap apne personal records access kar sakte hain.', en: 'Only you can access your personal records.' },
  onboard_safety_2: { ur: 'Sync se data devices par available rehta hai', en: 'Sync keeps your data available across devices' },
  onboard_safety_2_sub: { ur: 'Phone change ya reinstall par useful hai.', en: 'Useful when you change phone or reinstall the app.' },
  onboard_safety_3: { ur: 'Full account number kabhi mat daalein', en: 'Never enter full account number' },
  onboard_safety_3_sub: { ur: 'Last 4 digits ya nickname kaafi hain.', en: 'Last 4 digits or nickname are enough.' },
  onboard_safety_4: { ur: 'CVV, card PIN ya banking password kabhi mat daalein', en: 'Never enter CVV, card PIN or banking password' },
  onboard_safety_4_sub: { ur: 'Hisaab ko sensitive banking credentials ki zaroorat nahi.', en: 'Hisaab does not need sensitive banking credentials.' },
  onboard_safety_5: { ur: 'Hisaab bank nahi hai', en: 'Hisaab is not a bank' },
  onboard_safety_5_sub: { ur: 'Personal tracking ke liye use karein, banking replacement nahi.', en: 'Use it for personal tracking, not as a banking replacement.' },
  ...
  onboard_start_instruction: { ur: 'Continue karne ke liye Start Fresh par tap karein.', en: 'Tap Start Fresh to continue.' },
  ...
  contacts_link_help: {
    ur: 'Dusra person bhi Hisaab use kare aur apna code share kare. Phir yahan link karne ke baad loan/split approvals bheje ja sakte hain.',
